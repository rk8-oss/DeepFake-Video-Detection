...
def args_func():
    ...
    parser.add_argument('--checkpoint_path', type=str, help='The path of trained encoder.', default=None)
...
def get_model(args):
    ...
    # model = M2TRECL()
    model = M2TRECL(out_dim=128, image_size=224)
    ...
    try:
        ...
        print("Trying partial load due to mismatch")
...
def main():
    ...
    with tqdm(total=total_files, desc='Processing files', unit='file') as pbar:
        for process_data in test_data_list:
            ...
            filtered_data = [x for x in correlation_sum if x != 0]
            correlation_sum = filtered_data
    ...
    with open('test_result_ff__uadfv.json', 'w') as json_file:
